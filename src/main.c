  ...
  while (1) {
    ...
    while (page == 1) {
      ...
      *pCurrent_speed = measure_speed(time_value); // gets the current speed
      ...
      if (section1) {
        active_speed_control(pNeeded_speed_1, pCurrent_speed, pDuty,
                             5); // sets speed according to section 1

      } else if (section2) {
        active_speed_control(pNeeded_speed_2, pCurrent_speed, pDuty,
                             5); // sets speed according to section 2
      ...
      // &progressbar, &total_distance);

      progressbar +=
          (int)((total_distance / (distance1 + distance2)) *
                100); // calculates the progress % based on the distance

      printf("%f", needed_speed_1);
      ...
      printf("page1.x0.val=%d%c%c%c", (int)(total_distance * 100), 255, 255,
             255);
      printf("page1.x1.val=%d%c%c%c", (int)(*pNeeded_speed_2 * 100), 255, 255,
             255);
      printf("page1.x2.val=%d%c%c%c", (int)(*pCurrent_speed * 100), 255, 255,
             255);
      printf("page1.x3.val=%d%c%c%c", (int)(*pNeeded_speed_1 * 100), 255, 255,
             255);
    }
<<<<<<< HEAD
=======
...
>>>>>>> 65993ef7782b9656c2270a31aa2924fb8e3fe8ed
  }
  return 0;
}
